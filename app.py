...
# Set page title
st.set_page_config(page_title="Riyan Adi", page_icon = "desktop_computer", layout = "wide", initial_sidebar_state = "auto")
...
footer:after{
    content:'Copyright © 2023 Riyan Adi';
    position:relative;
    color:black;
}
"""
...
img_lh = Image.open("images\Mask group.png")
...
with st.sidebar:
    ...
    choose = option_menu(
                        ...
                        ["About Me", "Site Overview", "Experience", "Technical Skills", "Education", "Projects", "Competitions", "Volunteering", "Blog", "Gallery", "Resume", "Testimonials", "Contact"],
                         ...
                         default_index=0,
                         styles={
        "container": {"padding": "0!important", "background-color": "#8d8d20"},
        "icon": {"color": "#ffffff", "font-size": "20px"}, 
        "nav-link": {"font-size": "17px", "text-align": "left", "margin":"0px", "--hover-color": "#a71a1a", "color": "#020000",},
        "nav-link-selected": {"background-color": "#f0f03d"},
    }
    )
...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            ...
            st.write("👋🏻 Hi, I'm Riyan! I'm a data science and analytics undergraduate based in Singapore. Having prior relevant experiences in tech, reinsurance and consulting sectors, I am constantly seeking unique internships to broaden my horizons before embarking on my data career upon graduation.")
...
#st.write("---")
    ...
    if selected == "Overview":
        ...
        *Riyan Adi is the Marketing Director of the NUS Statistics and Data Science Society (AY21/22)*       
        """)
...
# Create section for Contact
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_ifg)
st.markdown("*Copyright © 2023 Riyan Adi*")
